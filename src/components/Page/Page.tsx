...
import { nextPage, previousPage, choosePageSize } from '../../state/order';
...
const mapStateToProps = (state: RootState) => {
	return {
		pageNumber: state.order.page,
		selectedPageSize: state.order.pageSize,
		nextPageExists: state.order.nextPageExists,
		previousPageExists: state.order.previousPageExists,
	};
};
